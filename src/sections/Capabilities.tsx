      ...
      >
        ...
        >
          <div style={{ flex: '1 1 500px' }}>
            ...
            >
              At Faith The Retreat, every detail is designed to make your stay
              comfortable and memorable. From complimentary breakfast to our
              signature rooftop restaurant, we ensure a homely experience:
            </p>
          </div>
          <div
            style={{
...
function OrbitalBadge() {
  ...
  useEffect(() => {
    ...
    const textContent = 'FAITH THE RETREAT \u2022 SILIGURI HOMESTAY \u2022 EST. 2018 \u2022 '
